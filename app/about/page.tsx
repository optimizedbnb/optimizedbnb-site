  ...
  return (
    <>
      ...
      <main className="pt-[calc(4rem+var(--banner-h))] min-h-screen">
        {/* Header */}
        <section className="bg-[#F7F7F7] border-b border-[#E5E5E5] py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-[#E8192C] text-xs font-semibold tracking-[0.3em] uppercase mb-4">Our Story</p>
            <h1 className="font-display text-5xl font-light text-[#111111] mb-6">
              Houston&apos;s{" "}
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="font-display text-3xl font-semibold text-[#111111] mb-6">Who We Are</h2>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={item.label} className="bg-white rounded-xl p-5 border border-[#E5E5E5]">
                  <div className="flex items-center gap-4">
                    <span className="font-display text-3xl font-bold text-[#E8192C]">{item.stat}</span>
                    <div>
                      <p className="text-[#111111] font-semibold text-sm">{item.label}</p>
        ...
        <section className="bg-[#F2F2F2] py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-3xl font-semibold text-[#111111] mb-10 text-center">What We Stand For</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                ...
                <div key={v.title} className="bg-white rounded-2xl p-6 border border-[#E5E5E5]">
                  <div className="text-3xl mb-4">{v.icon}</div>
                  <h3 className="text-[#111111] font-semibold mb-2">{v.title}</h3>
        ...
        <section className="py-20 px-4 text-center">
          ...
          <p className="text-[#666666] mb-8">Browse our full collection of luxury Houston suites.</p>
          <Link
            href="/suites"
