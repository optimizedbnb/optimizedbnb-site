      ...
      <main className="pt-[calc(4rem+var(--banner-h))] min-h-screen">
        ...
        <section className="bg-[#181818] border-b border-white/5 py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="font-display text-5xl lg:text-6xl font-light text-white leading-tight mb-6">
              Full-Service STR{" "}
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={s.title} className="bg-[#181818] rounded-2xl p-6 border border-white/5">
        ...
        <section className="bg-[#202020] py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-display text-3xl font-semibold text-white mb-10">Our Track Record</h2>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={s.label} className="bg-[#181818] rounded-2xl p-6 border border-white/5">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <h2 className="font-display text-3xl font-semibold text-white mb-10 text-center">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={s.step} className="flex gap-6 items-start bg-[#181818] rounded-2xl p-6 border border-white/5">
