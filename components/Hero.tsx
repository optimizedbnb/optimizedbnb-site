  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(ellipse at 50% 0%, rgba(232,25,44,0.4) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <form
          ...
          className="bg-[#181818] border border-white/10 rounded-2xl p-2 flex flex-col sm:flex-row items-stretch gap-2 max-w-2xl mx-auto shadow-2xl"
        >
          <div className="flex-1 flex flex-col px-4 py-2 border-b sm:border-b-0 sm:border-r border-white/10">
            <label className="text-white/40 text-xs font-medium uppercase tracking-wider mb-1">Check-in</label>
            <input
              type="date"
              value={checkIn}
          ...
          <div className="flex-1 flex flex-col px-4 py-2 border-b sm:border-b-0 sm:border-r border-white/10">
            <label className="text-white/40 text-xs font-medium uppercase tracking-wider mb-1">Check-out</label>
            <input
              type="date"
              value={checkOut}
          ...
          <div className="flex-1 flex flex-col px-4 py-2 border-b sm:border-b-0 sm:border-r border-white/10">
            <label className="text-white/40 text-xs font-medium uppercase tracking-wider mb-1">Guests</label>
            <select
              value={guests}
            ...
            >
              {[1, 2, 3, 4, 5, 6, 7, 8, 10, 12, 15].map((n) => (
                <option key={n} value={n} className="bg-[#181818]">
                  {n} guest{n !== 1 ? "s" : ""}
                </option>
              ))}
            </select>
        ...
        {/* Trust badges */}
        <div className="flex flex-wrap items-center justify-center gap-6 mt-10 text-white/40 text-xs">
