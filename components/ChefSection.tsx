...
export default function ChefSection() {
  return (
    <section id="chef" className="bg-[#F7F7F7] py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={item} className="flex items-center gap-3 text-[#666666] text-sm">
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl p-8 border border-[#E5E5E5]">
              ...
              <blockquote className="text-[#666666] text-base italic leading-relaxed mb-4">
              ...
              <p className="text-[#111111] font-semibold text-sm">Carly M.</p>
              <p className="text-[#666666] text-xs">Interior Design Professional</p>
            </div>
          </div>
        </div>
      </div>
